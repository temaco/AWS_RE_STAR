...
quarto = int((input("Insira o numero do quarto :  ")))
#Solicitar o numero de dias que vai ficar reservado sobre o total de um ano /365
dias = int(input("Insira o numero de dias da sua reserva: "))
...
servico_desejado =(input("Qual o serviço desejado? 1.servios de Contabilidade   2.Quartos de vazio ?"))
    #Serviços
